        ...
        setContent {
            Surface (
                ...
                Column (
                    ...
                    StopActivityButton (onBackPressedDispatcher, It)
                    CompareValue(applicationContext)
                }
            }
        }
    }
...
@Composable
fun StopActivityButton (onBackPressedDispatcher: OnBackPressedDispatcher, It: String?) {
    Column (
        horizontalAlignment = Alignment.CenterHorizontally
    ){
